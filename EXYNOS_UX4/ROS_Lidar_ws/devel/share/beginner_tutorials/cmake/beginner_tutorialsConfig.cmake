...
if("TRUE" STREQUAL "TRUE")
  set(beginner_tutorials_SOURCE_PREFIX /home/odroid/fake_laser/src/fakeLaserScan)
  set(beginner_tutorials_DEVEL_PREFIX /home/odroid/fake_laser/devel)
  ...
  set(beginner_tutorials_INSTALL_PREFIX /home/odroid/fake_laser/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/odroid/fake_laser/src/fakeLaserScan/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/odroid/fake_laser/devel/lib;/opt/ros/kinetic/lib)
