...
void I2C1_Initialize(void){
	...
	RCC_APB1PeriphClockCmd(RCC_APB1Periph_I2C1,ENABLE); 	// active l’horloge sur lequel est connecté l'I2C1
	RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOB,ENABLE);	// active l’horloge périphérique du portB
	...
	I2C_Init(I2C1,&I2C_init);			// configuration des paramètres de transmission
	I2C_Cmd(I2C1,ENABLE);				// active le périphérique I2C1.
	
}


void I2C_start(I2C_TypeDef* I2Cx, uint8_t address, uint8_t direction){
	while(I2C_GetFlagStatus(I2Cx,I2C_FLAG_BUSY)); // attend que l'i2c ne soit plus occupé
	...
	if(direction == I2C_Direction_Transmitter)
		while(!I2C_CheckEvent(I2Cx,I2C_EVENT_MASTER_TRANSMITTER_MODE_SELECTED));	// attendre l’acquittement du mode émetteur 
	if(direction == I2C_Direction_Receiver)
		while(!I2C_CheckEvent(I2Cx,I2C_EVENT_MASTER_RECEIVER_MODE_SELECTED));	// attendre l’acquittement du mode récepteur
...
int get_distance(void){
	...
	// lecture de la donnée en 0x10 
	I2C_start(I2C1,LIDAR_ADD <<1 ,I2C_Direction_Transmitter);
	I2C_SendData(I2C1,0x10);
	while(!I2C_CheckEvent(I2C1,I2C_EVENT_MASTER_BYTE_TRANSMITTED));	// Attends que l’esclave I2C3 ait reçu la donnée
	I2C_GenerateSTOP(I2C1, ENABLE);
	
	I2C_start(I2C1,LIDAR_ADD << 1  ,I2C_Direction_Receiver);
	while(!I2C_CheckEvent(I2C1,I2C_EVENT_MASTER_BYTE_RECEIVED));	// Attends que l’esclave I2C3 ait reçu la donnée
	distanceA=I2C_ReceiveData(I2C1);
	I2C_GenerateSTOP(I2C1, ENABLE);
	
	
	// lecture de la donnée en 0x0f
	I2C_start(I2C1,LIDAR_ADD <<1 ,I2C_Direction_Transmitter);
